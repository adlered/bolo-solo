...
* 这是菠萝博客的一个里程碑版本，该版本代码做出了大量整理优化，添加了众多本地化功能，菠萝博客可以独立运行了。

新版亮点

* 版本更新检测，不用手动检测了
* 大量简化，降低「内容侵略性」
* 后台增加「日志浏览」选项卡，出现问题不用再连接服务器啦~ 打开后台直接 Debug
* 支持本地自定义联系方式啦！
* 支持自定义文章发布时间
...
* 新功能小气泡提醒
* Fantastic 皮肤 Bug 修复
* 由于黑客派防火墙不稳定，暂时移除后台“社区推荐”插件
* 修复 看板娘面板换肤按钮在固定看板娘功能后无法使用 的问题
</details>
...
|[Solo 原作者](https://hacpai.com)|[参与菠萝博客开发、前端及皮肤技术支持](https://sszsj.top)|[菠萝博客首席体验官](https://inkdp.cn)|
...
如果发现 Demo 网站不正常或不小心玩坏，请微信扫描 [人工帮助](#人工帮助) 中的二维码告知我们，谢谢！  
...
* [糖醋鱼：菠萝博客 docker-compose 简易安装项目维护者](https://github.com/expoli)
