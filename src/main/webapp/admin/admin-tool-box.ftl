...
<div id="filler"><script>
        ...
        function backup() {
            $.ajax({
                ...
                error: function (e) {
                    if (e.status === 404) {
                        alert("抱歉，当前 Bolo 版本不支持该功能！小提示：重启服务端，等待 5 分钟后，Bolo 会自动备份文章到黑客派（功能开启的情况下）。");
                    } else {
                        alert("备份失败！请检查偏好设置，并确定黑客派用户名和 B3log Key 设置正确。");
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                error: function (e) {
                    if (e.status === 404) {
                        ...
                        alert("获取失败！请检查 黑客派用户名 及 B3log Key 是否正确！");
                    }
                }
            });
        }
            ...
            <div id="pluginTableTableMain" class="table-body" style="height:auto">
                <table id="pluginTableSubTable0" style="width:100%;background-color: white;" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="table-hasExpend">
                        ...
                        <td>
                            使用此功能需要在 设置 - 偏好设定 - 参数设置 中开启 备份公开文章到社区 功能。
                        </td>
                        <td style="padding-right: 20px;">
                    ...
                    <tr class="table-hasExpend">
                        ...
                        <td>
                            你将从指定 黑客派用户名 和 B3log Key 的黑客派账户中获取你的社交媒体信息，本地自定义联系方式将被覆盖。
                        </td>
                        <td style="padding-right: 20px;">
