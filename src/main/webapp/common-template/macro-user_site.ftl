...
<#macro userSite dir>
    <#if usite??>
        <#if hacpaiUser != ''>
            <a href="https://${hacpaiDomain}/member/${adminUser.userName}"
               <#if dir==''>title<#else>aria-label</#if>="https://${hacpaiDomain}/member/${adminUser.userName}"
        ...
        <#if usite.usiteTelegram != ''>
            <a href="https://telegram.me/${usite.usiteTelegram}"
               ...
               rel="noopener nofollow">
                <svg viewBox="0 0 32 32" width="100%" height="100%">
                    <path d="M12.036 27.787c-0.952 0-0.791-0.361-1.119-1.266l-2.805-9.23 21.577-12.802z"></path>
                    <path d="M12.036 27.787c0.736 0 1.060-0.336 1.474-0.738l3.923-3.811-4.896-2.953z"></path>
                    <path d="M12.536 20.285l11.857 8.76c1.354 0.747 2.331 0.361 2.668-1.256l4.828-22.745c0.496-1.983-0.752-2.88-2.046-2.294l-28.348 10.933c-1.934 0.776-1.925 1.857-0.352 2.338l7.276 2.267 16.838-10.621c0.794-0.48 1.525-0.223 0.926 0.309z"></path>
                </svg>
            </a>
        </#if>
        <#if usite.usiteWeiBo != ''>
