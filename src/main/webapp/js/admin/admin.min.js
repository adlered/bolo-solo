...
var last=-1;admin.others={init:function(){$("#tabOthers").tabs(),$("#loadMsg").text(""),admin.others.getLog(),setInterval(this.getLog,5e3)},getLog:()=>{$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:2e3,success:function(t){var e=t.result;let s=(t.freeMemNow/1048576).toFixed(2)+" MB";$("#memFree").html(s),$("#now").html((new Date).toLocaleTimeString());for(var a=0;a<e.length;a++){var o=e[a],n=o.id;if(n>last){var l=o.date,r=o.level,c=o.name+":"+o.lineNumber,i=o.message;let t='<tbody class="table-oddRow"><tr class="table-hasExpend">';l=l.substring(0,19);let e="";e="WARN"===r?'<td style="width: 40px; vertical-align: top"><span style="color: #f8ba0b; font-weight: bold">'+r+"</span></td>":"INFO"===r?'<td style="width: 40px; vertical-align: top"><span style="color: #00bbff; font-weight: bold">'+r+"</span></td>":"ERROR"===r?'<td style="width: 40px; vertical-align: top"><span style="color: #dd1144" font-weight: bold">'+r+"</span></td>":'<td style="width: 40px; vertical-align: top"><span style="color: #1ea0c3" font-weight: bold">'+r+"</span></td>";var p=t+e+('<td style="width: 135px; vertical-align: top"><span style="color: #4caf50; font-weight: bold">'+l+"</span></td>")+('<td style="vertical-align: top"><span style="word-wrap: break-word; white-space: normal; word-break: break-all"><span style="color: #4caf50; font-weight: bold">'+c+"</span><br>"+i+"</span></td>")+"</tr></tbody>";if(void 0!==o.throwable){p+=o.throwable.class+": "+o.throwable.message+"<br>";for(var d=0;d<o.throwable.stackTrace.length;d++)p+=o.throwable.stackTrace[d]+"<br>"}$("#tabOthersPanel_log #logList").prepend(p),last=n}}}})},removeUnusedArchives:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/archive/unused",type:"DELETE",cache:!1,success:function(t,e){$("#tipMsg").text(t.msg)}})},removeUnusedTags:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/tag/unused",type:"DELETE",cache:!1,success:function(t,e){$("#tipMsg").text(t.msg)}})},exportSQL:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/sql",type:"GET",cache:!1,success:function(t,e){t.sc?$("#tipMsg").text(t.msg):window.location=Label.servePath+"/console/export/sql"}})},exportJSON:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/json",type:"GET",cache:!1,success:function(t,e){t.sc?$("#tipMsg").text(t.msg):window.location=Label.servePath+"/console/export/json"}})},exportHexo:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/hexo",type:"GET",cache:!1,success:function(t,e){t.sc?$("#tipMsg").text(t.msg):window.location=Label.servePath+"/console/export/hexo"}})},getUnusedTags:function(){$.ajax({url:Label.servePath+"/console/tag/unused",type:"GET",cache:!1,success:function(t,e){($("#tipMsg").text(t.msg),t.sc)?t.unusedTags.length:$("#loadMsg").text("")}})},pbstart:function(){$.ajax({url:Label.servePath+"/PBC/run",type:"GET",cache:!1,success:function(t,e){$("#tipMsg").text("\u8bf7\u6c42\u5df2\u63d0\u4ea4")}})}},admin.register.others={obj:admin.others,init:admin.others.init,refresh:function(){admin.clearTip()}};
