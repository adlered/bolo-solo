...
admin.editors={};var SoloEditor=function(e){this.conf=e,this.init()};$.extend(SoloEditor.prototype,{init:function(){$.ajax({url:"https://hacpai.com/apis/vcomment/users/emotions",type:"GET",cache:!0,async:!1,xhrFields:{withCredentials:!0},success:function(e){Label.emoji={},Array.isArray(e.data)&&e.data.forEach(e=>{const t=Object.keys(e)[0];Label.emoji[t]=e[t]})}});const e={outline:this.conf.outline||!1,mode:Label.editorMode,typewriterMode:this.conf.typewriterMode,cache:{enable:!0},tab:"\t",preview:{delay:500,mode:this.conf.previewMode,url:Label.servePath+"/console/markdown/2html",hljs:{enable:!Label.luteAvailable,style:Label.hljsStyle},parse:function(e){"none"!==e.style.display&&Util.parseMarkdown()}},upload:{max:10485760,url:Label.uploadURL,linkToImgUrl:Label.servePath+"/upload/fetch",token:Label.uploadToken,filename:function(e){return e.replace(/[^(a-zA-Z0-9\u4e00-\u9fa5\.)]/g,"").replace(/[\?\\/:|<>\*\[\]\(\)\$%\{\}@~]/g,"").replace("/\\s/g","")}},height:this.conf.height,counter:{enable:!0,max:102400},resize:{enable:this.conf.resize},lang:Label.localeString,hint:{emojiTail:'<a href="https://hacpai.com/settings/function" target="_blank">\u8bbe\u7f6e\u5e38\u7528\u8868\u60c5</a>',emoji:Label.emoji},toolbarConfig:{pin:!0},toolbar:["emoji","headings","bold","link","|","list","ordered-list","check","outdent","indent","|","quote","code","insert-before","insert-after","|","upload","record","table","|","undo","redo","|","fullscreen","edit-mode",{name:"more",toolbar:["italic","strike","line","inline-code","both","code-theme","content-theme","export","outline","preview","format","devtools","info","help"]}],after:()=>{"function"==typeof this.conf.fun&&this.conf.fun()}};$(window).width()<768&&(e.toolbar=["emoji","link","upload","edit-mode",{name:"more",toolbar:["insert-after","fullscreen","preview","format","info","help"]}],e.resize.enable=!1,e.toolbarConfig.pin=!0),"undefined"==typeof Vditor?Util.loadVditor(()=>{this.editor=new Vditor(this.conf.id,e)}):this.editor=new Vditor(this.conf.id,e)},getContent:function(){return this.editor.getValue()},setContent:function(e){this.editor.setValue(e)},remove:function(){document.getElementById(this.editor.vditor.id).outerHTML=""}}),admin.editors.articleEditor={},admin.editors.abstractEditor={};
...
var last=-1;admin.others={init:function(){$("#tabOthers").tabs(),$("#loadMsg").text(""),clearInterval(admin.others.intervalId),admin.others.intervalId=setInterval(()=>{admin.others.getLog(!1)},1e3),admin.others.getLog(!0)},getLog:t=>{t?$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:3e3,success:function(t){var e=t.result;let a=(t.freeMemNow/1048576).toFixed(2)+" MB";$("#memFree").html(a),$("#now").html((new Date).toLocaleTimeString());for(var s=0;s<e.length;s++){var o=e[s],l=o.id,n=o.date,r=o.level,i=o.name+":"+o.lineNumber,c=o.message;let t='<tbody class="table-oddRow"><tr class="table-hasExpend">';n=n.substring(0,19);let a="";a="WARN"===r?'<td style="width: 40px; vertical-align: top"><span style="color: #f8ba0b; font-weight: bold">'+r+"</span></td>":"INFO"===r?'<td style="width: 40px; vertical-align: top"><span style="color: #00bbff; font-weight: bold">'+r+"</span></td>":'<td style="width: 40px; vertical-align: top"><span style="color: #1ea0c3" font-weight: bold">'+r+"</span></td>";var d=t+a+('<td style="width: 135px; vertical-align: top"><span style="color: #4caf50; font-weight: bold">'+n+"</span></td>")+('<td style="vertical-align: top"><span style="word-wrap: break-word; white-space: normal; word-break: break-all"><span style="color: #4caf50; font-weight: bold">'+i+"</span><br>"+c+"</span></td>")+"</tr></tbody>";if(void 0!==o.throwable){d+=o.throwable.class+": "+o.throwable.message+"<br>";for(var p=0;p<o.throwable.stackTrace.length;p++)d+=o.throwable.stackTrace[p]+"<br>"}$("#tabOthersPanel_log #logList").prepend(d),last=l}}}):$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:3e3,success:function(t){var e=t.result,a=e[e.length-1],s=a.id;let o=(t.freeMemNow/1048576).toFixed(2)+" MB";if($("#memFree").html(o),$("#now").html((new Date).toLocaleTimeString()),s!==last){var l=a.date,n=a.level,r=a.name+":"+a.lineNumber,i=a.message;let t='<tbody class="table-oddRow"><tr class="table-hasExpend">';l=l.substring(0,19);let e="";e="WARN"===n?'<td style="width: 40px; vertical-align: top"><span style="color: #f8ba0b; font-weight: bold">'+n+"</span></td>":"INFO"===n?'<td style="width: 40px; vertical-align: top"><span style="color: #00bbff; font-weight: bold">'+n+"</span></td>":'<td style="width: 40px; vertical-align: top"><span style="color: #1ea0c3" font-weight: bold">'+n+"</span></td>";var c=t+e+('<td style="width: 135px; vertical-align: top"><span style="color: #4caf50; font-weight: bold">'+l+"</span></td>")+('<td style="vertical-align: top"><span style="word-wrap: break-word; white-space: normal; word-break: break-all"><span style="color: #4caf50; font-weight: bold">'+r+"</span><br>"+i+"</span></td>")+"</tr></tbody>";if(void 0!==a.throwable){c+=a.throwable.class+": "+a.throwable.message+"<br>";for(var d=0;d<a.throwable.stackTrace.length;d++)c+=a.throwable.stackTrace[d]+"<br>"}$("#tabOthersPanel_log #logList").prepend(c)}last=s}})},removeUnusedArchives:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/archive/unused",type:"DELETE",cache:!1,success:function(t,e){$("#tipMsg").text(t.msg)}})},removeUnusedTags:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/tag/unused",type:"DELETE",cache:!1,success:function(t,e){$("#tipMsg").text(t.msg)}})},exportSQL:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/sql",type:"GET",cache:!1,success:function(t,e){t.sc?$("#tipMsg").text(t.msg):window.location=Label.servePath+"/console/export/sql"}})},exportJSON:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/json",type:"GET",cache:!1,success:function(t,e){t.sc?$("#tipMsg").text(t.msg):window.location=Label.servePath+"/console/export/json"}})},exportHexo:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/hexo",type:"GET",cache:!1,success:function(t,e){t.sc?$("#tipMsg").text(t.msg):window.location=Label.servePath+"/console/export/hexo"}})},getUnusedTags:function(){$.ajax({url:Label.servePath+"/console/tag/unused",type:"GET",cache:!1,success:function(t,e){($("#tipMsg").text(t.msg),t.sc)?t.unusedTags.length:$("#loadMsg").text("")}})}},admin.register.others={obj:admin.others,init:admin.others.init,refresh:function(){admin.clearTip()}};
...
admin.preference={locale:"",editorMode:"",init:function(){$("#tabPreference").tabs(),$.ajax({url:Label.servePath+"/console/preference/",type:"GET",cache:!1,success:function(result,textStatus){if($("#tipMsg").text(result.msg),result.sc){var preference=result.preference;$.ajax({url:Label.servePath+"/plugins/kanbanniang/assets/list",type:"GET",async:!1,success:function(e){for(var t=e.msg.split(";"),a=0;a<t.length;a++)$("#kanbanniangSelector").append('<option value="'+t[a]+'">'+t[a]+"</option>")}}),$("#spam").val(preference.spam),$("#kanbanniangSelector").val(preference.kanbanniangSelector),$("#replyRemind").val(preference.replyRemind),$("#sourceTC").text(preference.tuChuangConfig),sltd=$("#sourceTC").text().split("<<>>")[0],$("#tcS").val(sltd),$("#hacpaiUser").val(preference.hacpaiUser),$("#b3logKey").val(preference.b3logKey),$("#mailBox").val(preference.mailBox),$("#mailUsername").val(preference.mailUsername),$("#mailPassword").val(preference.mailPassword),$("#metaKeywords").val(preference.metaKeywords),$("#metaDescription").val(preference.metaDescription),$("#blogTitle").val(preference.blogTitle),$("#blogSubtitle").val(preference.blogSubtitle),$("#mostCommentArticleDisplayCount").val(preference.mostCommentArticleDisplayCount),$("#mostViewArticleDisplayCount").val(preference.mostViewArticleDisplayCount),$("#recentCommentDisplayCount").val(preference.recentCommentDisplayCount),$("#mostUsedTagDisplayCount").val(preference.mostUsedTagDisplayCount),$("#articleListDisplayCount").val(preference.articleListDisplayCount),$("#articleListPaginationWindowSize").val(preference.articleListPaginationWindowSize),$("#localeString").val(preference.localeString),$("#timeZoneId").val(preference.timeZoneId),$("#noticeBoard").val(preference.noticeBoard),$("#footerContent").val(preference.footerContent),$("#htmlHead").val(preference.htmlHead),$("#externalRelevantArticlesDisplayCount").val(preference.externalRelevantArticlesDisplayCount),$("#relevantArticlesDisplayCount").val(preference.relevantArticlesDisplayCount),$("#randomArticlesDisplayCount").val(preference.randomArticlesDisplayCount),$("#customVars").val(preference.customVars),$("#maxArchive").val(preference.maxArchive),"true"===preference.enableArticleUpdateHint?$("#enableArticleUpdateHint").attr("checked","checked"):$("#enableArticleUpdateHint").removeAttr("checked"),"true"===preference.allowVisitDraftViaPermalink?$("#allowVisitDraftViaPermalink").attr("checked","checked"):$("allowVisitDraftViaPermalink").removeAttr("checked"),"true"===preference.commentable?$("#commentable").attr("checked","checked"):$("commentable").removeAttr("checked"),"true"===preference.syncGitHub?$("#syncGitHub").attr("checked","checked"):$("syncGitHub").removeAttr("checked"),"true"===preference.pullGitHub?$("#pullGitHub").attr("checked","checked"):$("pullGitHub").removeAttr("checked"),$("input:radio[value='"+preference.editorMode+"']").attr("checked","true"),admin.preference.editorMode=preference.editorMode,admin.preference.locale=preference.localeString;for(var signs=eval("("+preference.signs+")"),j=1;j<signs.length;j++)$("#preferenceSign"+j).val(signs[j].signHTML);$("#articleListDisplay").val(preference.articleListStyle),$("#hljsTheme").val(preference.hljsTheme),$("#feedOutputMode").val(preference.feedOutputMode),$("#feedOutputCnt").val(preference.feedOutputCnt),$("#faviconURL").val(preference.faviconURL),$("#loadMsg").text("")}else $("#loadMsg").text("")}})},validate:function(){return/^\d+$/.test($("#mostUsedTagDisplayCount").val())?/^\d+$/.test($("#recentCommentDisplayCount").val())?/^\d+$/.test($("#mostCommentArticleDisplayCount").val())?/^\d+$/.test($("#mostViewArticleDisplayCount").val())?/^\d+$/.test($("#articleListDisplayCount").val())?/^\d+$/.test($("#articleListPaginationWindowSize").val())?/^\d+$/.test($("#randomArticlesDisplayCount").val())?/^\d+$/.test($("#relevantArticlesDisplayCount").val())?!!/^\d+$/.test($("#externalRelevantArticlesDisplayCount").val())||($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.externalRelevantArticlesDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#externalRelevantArticlesDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.relevantArticlesDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#relevantArticlesDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.randomArticlesDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#randomArticlesDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.windowSizeLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#articleListPaginationWindowSize").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.pageSizeLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#articleListDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.indexMostViewArticleDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#mostViewArticleDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.indexMostCommentArticleDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#mostCommentArticleDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.indexRecentCommentDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#recentCommentDisplayCount").focus(),!1):($("#tipMsg").text("["+Label.paramSettingsLabel+" - "+Label.indexTagDisplayCntLabel+"] "+Label.nonNegativeIntegerOnlyLabel),$("#mostUsedTagDisplayCount").focus(),!1)},update:function(){if(admin.preference.validate()){$("#tipMsg").text(""),$("#loadMsg").text(Label.loadingLabel);var e=[{oId:0,signHTML:""},{oId:1,signHTML:$("#preferenceSign1").val()},{oId:2,signHTML:$("#preferenceSign2").val()},{oId:3,signHTML:$("#preferenceSign3").val()}],t={preference:{spam:$("#spam").val(),kanbanniangSelector:$("#kanbanniangSelector").val(),replyRemind:$("#replyRemind").val(),tuChuangConfig:$("#sourceTC").text(),hacpaiUser:$("#hacpaiUser").val(),b3logKey:$("#b3logKey").val(),mailBox:$("#mailBox").val(),mailUsername:$("#mailUsername").val(),mailPassword:$("#mailPassword").val(),metaKeywords:$("#metaKeywords").val(),metaDescription:$("#metaDescription").val(),blogTitle:$("#blogTitle").val(),blogSubtitle:$("#blogSubtitle").val(),mostCommentArticleDisplayCount:$("#mostCommentArticleDisplayCount").val(),mostViewArticleDisplayCount:$("#mostViewArticleDisplayCount").val(),recentCommentDisplayCount:$("#recentCommentDisplayCount").val(),mostUsedTagDisplayCount:$("#mostUsedTagDisplayCount").val(),articleListDisplayCount:$("#articleListDisplayCount").val(),articleListPaginationWindowSize:$("#articleListPaginationWindowSize").val(),localeString:$("#localeString").val(),timeZoneId:$("#timeZoneId").val(),noticeBoard:$("#noticeBoard").val(),footerContent:$("#footerContent").val(),htmlHead:$("#htmlHead").val(),externalRelevantArticlesDisplayCount:$("#externalRelevantArticlesDisplayCount").val(),relevantArticlesDisplayCount:$("#relevantArticlesDisplayCount").val(),randomArticlesDisplayCount:$("#randomArticlesDisplayCount").val(),enableArticleUpdateHint:$("#enableArticleUpdateHint").prop("checked"),signs:e,allowVisitDraftViaPermalink:$("#allowVisitDraftViaPermalink").prop("checked"),articleListStyle:$("#articleListDisplay").val(),hljsTheme:$("#hljsTheme").val(),feedOutputMode:$("#feedOutputMode").val(),feedOutputCnt:$("#feedOutputCnt").val(),faviconURL:$("#faviconURL").val(),syncGitHub:$("#syncGitHub").prop("checked"),pullGitHub:$("#pullGitHub").prop("checked"),commentable:$("#commentable").prop("checked"),customVars:$("#customVars").val(),maxArchive:$("#maxArchive").val(),editorMode:$("input[name='editorMode']:checked").val()}};$.ajax({url:Label.servePath+"/console/preference/",type:"PUT",cache:!1,data:JSON.stringify(t),success:function(e,t){$("#tipMsg").text(e.msg),e.sc?($("#localeString").val()===admin.preference.locale&&$("input[name='editorMode']:checked").val()===admin.preference.editorMode||window.location.reload(),$("#loadMsg").text(""),window.location.reload()):$("#loadMsg").text("")}})}}},admin.register.preference={obj:admin.preference,init:admin.preference.init,refresh:function(){admin.clearTip()}};
admin.themeList={skinDirName:"",mobileSkinDirName:"",init:function(){$.ajax({url:Label.servePath+"/console/skin",type:"GET",cache:!1,success:function(i,e){if($("#tipMsg").text(i.msg),i.sc){admin.themeList.skinDirName=i.skin.skinDirName,admin.themeList.mobileSkinDirName=i.skin.mobileSkinDirName;for(var t=JSON.parse(i.skin.skins),a="",s=0;s<t.length;s++){var n="";t[s].skinDirName===i.skin.skinDirName&&(n=" selected"),a+='<div class="fn__left skinItem'+n+'"><div class="ft__center">'+t[s].skinDirName+'</div><img class="skinPreview" src="'+Label.staticServePath+"/skins/"+t[s].skinDirName+'/preview.png"/><div>',t[s].skinDirName!==i.skin.skinDirName&&(a+='<button class="small update fn__left" data-name="'+t[s].skinDirName+'">'+Label.enableLabel+"</button>"),t[s].skinDirName!==i.skin.mobileSkinDirName&&(a+='<button class="small mobile fn__left" data-name="'+t[s].skinDirName+'">'+Label.setMobileLabel+"</button>"),a+='<button class="small fn__right" onclick="window.open(\''+Label.servePath+"?skin="+t[s].skinDirName+"')\">"+Label.previewLabel+"</button></div></div>"}$("#skinMain").html(a+"<div class='fn__clear'></div>"),$(".skinItem .update").click((function(){admin.themeList.update($(this).data("name"),"pc")})),$(".skinItem .mobile").click((function(){admin.themeList.update($(this).data("name"),"mobile")})),$("#loadMsg").text("")}else $("#loadMsg").text("")}})},update:function(i,e){$("#tipMsg").text(""),$("#loadMsg").text(Label.loadingLabel);var t={skin:{skinDirName:admin.themeList.skinDirName,mobileSkinDirName:admin.themeList.mobileSkinDirName}};"pc"===e?t.skin.skinDirName=i:t.skin.mobileSkinDirName=i,$.ajax({url:Label.servePath+"/console/skin",type:"PUT",cache:!1,data:JSON.stringify(t),success:function(i,e){$("#tipMsg").text(i.msg),i.sc?(admin.themeList.init(),$("#loadMsg").text("")):$("#loadMsg").text("")}})}},admin.register["theme-list"]={obj:admin.themeList,init:admin.themeList.init,refresh:function(){$("#loadMsg").text("")}};
...
admin.about={init:function(){version=version.split(" ")[0],version=version.substr(1),version=version.replace(".","_");var o="bolo_v"+version+"_stable.zip",e="https://ftp.stackoverflow.wiki/bolo/releases/"+o;console.info("\u5f53\u524d\u7248\u672c\u6821\u9a8c\u4e2d\uff1a"+e);var n=version;$.ajax({url:e,type:"head",error:function(){$("#updateCheck").html('<font style="color: #e94c89">\u7248\u672c\u66f4\u65b0\u68c0\u67e5\u5931\u8d25\uff0c\u7f51\u7edc\u9519\u8bef\u6216\u8be5\u7248\u672c\u4e3a\u5185\u6d4b\u7248\u672c\u3002</font>'),$("#loadMsg").text("")},success:function(){console.info("\u5f53\u524d\u7248\u672c\u5728\u6570\u636e\u5e93\u4e2d\u5b58\u5728\uff01\u67e5\u8be2\u65b0\u7248\u672c...");var t=version.indexOf("_"),s=String(version.replace("_",""));console.info("\u7248\u672c\u5206\u9694\u7b26\u4f4d\u7f6e\uff1a"+t+"; \u7248\u672c\u5e8f\u5217\u53f7\uff1a"+s);for(var i=s.length,r=!0;r;){var a=(s=String(Number(s)+1)).length;i!==a&&t++,i=a,console.info("\u88f8\u7248\u672c\u53f7\uff1a"+s);var l=s.substr(0,t)+"_"+s.substr(t);console.info("\u67e5\u8be2\u53f7\uff1a"+l),e="https://ftp.stackoverflow.wiki/bolo/releases/"+(o="bolo_v"+l+"_stable.zip"),console.info("\u67e5\u8be2\u7248\u672c\u4ed3\u5e93\uff1a"+e),$.ajax({url:e,type:"head",async:!1,error:function(){console.info("\u7248\u672c v"+l.replace("_",".")+" \u4e0d\u5b58\u5728\uff0c\u505c\u6b62\u904d\u5386"),r=!1},success:function(){n=l,console.info("\u7248\u672c v"+l.replace("_",".")+" \u5b58\u5728\uff0c\u7ee7\u7eed\u67e5\u8be2\u4e0b\u4e00\u4e2a...")}})}version===n?$("#updateCheck").html('\ud83c\udf4d <font style="color: #3caf36">\u4f60\u6b63\u5728\u4f7f\u7528\u83e0\u841d\u535a\u5ba2\u6700\u65b0\u7248\uff01</font>'):$("#updateCheck").html('<font style="color: #991a1a">\u83e0\u841d\u535a\u5ba2 v'+n.replace("_",".")+" \u5df2\u63a8\u51fa\uff0c\u8d76\u5feb\u66f4\u65b0\u5427\uff01</font>"),$("#tipMsg").text(""),$("#loadMsg").text("")}})}},admin.register.about={obj:admin.about,init:admin.about.init,refresh:function(){admin.clearTip()}};
...
var formatJson=function(e,t){var n=null,i="",a=0;return(t=t||{}).newlineAfterColonIfBeforeBraceOrBracket=!0===t.newlineAfterColonIfBeforeBraceOrBracket,t.spaceAfterColon=!1!==t.spaceAfterColon,"string"!=typeof e&&(e=JSON.stringify(e)),e=JSON.parse(e),n=/([\{\}])/g,e=(e=JSON.stringify(e)).replace(n,"\r\n$1\r\n"),n=/([\[\]])/g,e=e.replace(n,"\r\n$1\r\n"),n=/(\,)/g,e=e.replace(n,"$1\r\n"),n=/(\r\n\r\n)/g,e=e.replace(n,"\r\n"),n=/\r\n\,/g,e=e.replace(n,","),t.newlineAfterColonIfBeforeBraceOrBracket||(n=/\:\r\n\{/g,e=e.replace(n,":{"),n=/\:\r\n\[/g,e=e.replace(n,":[")),t.spaceAfterColon&&(n=/\:/g,e=e.replace(n,": ")),$.each(e.split("\r\n"),(function(e,t){var n=0,r=0,s="";for(t.match(/\{$/)||t.match(/\[$/)?r=1:t.match(/\}/)||t.match(/\]/)?0!==a&&(a-=1):r=0,n=0;n<a;n++)s+="    ";i+=s+t+"\r\n",a+=r})),i};admin.usite={locale:"",init:function(){$("#tabUsite").tabs(),$("#loadMsg").text(""),$.ajax({url:Label.servePath+"/admin/usite/get",type:"GET",async:!1,success:function(e){""===e.msg?admin.usite.reset():$("#usiteEditor").val(formatJson(e.msg))}})},validate:function(){return!0},update:function(){$.ajax({url:Label.servePath+"/admin/usite/set",type:"POST",async:!1,dataType:"json",data:$("#usiteEditor").val(),success:function(e){200===e.code?($("#loadMsg").text("\u8054\u7cfb\u65b9\u5f0f\u5143\u6570\u636e\u66f4\u65b0\u6210\u529f\uff01"),setTimeout((function(){$("#loadMsg").text("")}),4e3)):($("#loadMsg").text("\u8054\u7cfb\u65b9\u5f0f\u5143\u6570\u636e\u66f4\u65b0\u5931\u8d25\uff01\u8bf7\u68c0\u67e5\u5143\u6570\u636e\u5185\u5bb9\u540e\u91cd\u8bd5\u3002"),setTimeout((function(){$("#loadMsg").text("")}),4e3))}})},reset:function(){$("#usiteEditor").val('\n{\n    "usiteUserId": "",\n    "usiteWeiBo": "",\n    "usiteQQMusic": "",\n    "usiteStackOverflow": "",\n    "usiteDribbble": "",\n    "usiteGitHub": "",\n    "usiteMedium": "",\n    "usiteTwitter": "",\n    "usiteQQ": "",\n    "usiteLinkedIn": "",\n    "usiteSteam": "",\n    "oId": "",\n    "usiteInstagram": "",\n    "usiteCodePen": "",\n    "usiteWYMusic": "",\n    "usiteWeChat": "",\n    "usiteZhiHu": "",\n    "usiteBehance": "",\n    "usiteTelegram": "",\n    "usiteFacebook": ""\n}\n\n')}},admin.register.usite={obj:admin.usite,init:admin.usite.init,refresh:function(){admin.clearTip()}};