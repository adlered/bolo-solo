...
var last=-1;admin.others={init:function(){$("#tabOthers").tabs(),$("#loadMsg").text(""),clearInterval(admin.others.intervalId),admin.others.intervalId=setInterval(()=>{admin.others.getLog(!1)},1e3),admin.others.getLog(!0)},getLog:e=>{e?$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:3e3,success:function(e){for(var t=e.result,a=0;a<t.length;a++){var s=t[a],o=s.id,n=s.date,r="[ "+s.level+" ] [ "+n+" "+(s.name+":"+s.lineNumber)+" ] "+s.message+"\n";if($("#memFree").html((s.freeMemory/1048576).toFixed(2)+" MB"),void 0!==s.throwable){r+=s.throwable.class+": "+s.throwable.message+"\n";for(var c=0;c<s.throwable.stackTrace.length;c++)r+=s.throwable.stackTrace[c]+"\n"}$("#tabOthersPanel_log textarea").append(r),last=o}}}):$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:3e3,success:function(e){var t=e.result,a=t[t.length-1],s=a.id;if(s!==last){var o=a.date,n="[ "+a.level+" ] [ "+o+" "+(a.name+":"+a.lineNumber)+" ] "+a.message+"\n";if($("#memFree").html((a.freeMemory/1048576).toFixed(2)+" MB"),void 0!==a.throwable){n+=a.throwable.class+": "+a.throwable.message+"\n";for(var r=0;r<a.throwable.stackTrace.length;r++)n+=a.throwable.stackTrace[r]+"\n"}$("#tabOthersPanel_log textarea").append(n)}last=s}})},removeUnusedArchives:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/archive/unused",type:"DELETE",cache:!1,success:function(e,t){$("#tipMsg").text(e.msg)}})},removeUnusedTags:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/tag/unused",type:"DELETE",cache:!1,success:function(e,t){$("#tipMsg").text(e.msg)}})},exportSQL:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/sql",type:"GET",cache:!1,success:function(e,t){e.sc?$("#tipMsg").text(e.msg):window.location=Label.servePath+"/console/export/sql"}})},exportJSON:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/json",type:"GET",cache:!1,success:function(e,t){e.sc?$("#tipMsg").text(e.msg):window.location=Label.servePath+"/console/export/json"}})},exportHexo:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/hexo",type:"GET",cache:!1,success:function(e,t){e.sc?$("#tipMsg").text(e.msg):window.location=Label.servePath+"/console/export/hexo"}})},getUnusedTags:function(){$.ajax({url:Label.servePath+"/console/tag/unused",type:"GET",cache:!1,success:function(e,t){($("#tipMsg").text(e.msg),e.sc)?e.unusedTags.length:$("#loadMsg").text("")}})}},admin.register.others={obj:admin.others,init:admin.others.init,refresh:function(){admin.clearTip()}};
