...
var last=-1;admin.others={init:function(){$("#tabOthers").tabs(),$("#loadMsg").text(""),clearInterval(admin.others.intervalId),admin.others.intervalId=setInterval(()=>{admin.others.getLog(!1)},1e3),admin.others.getLog(!0)},getLog:e=>{e?$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:3e3,success:function(e){var t=e.result;let a=(e.freeMemNow/1048576).toFixed(2)+" MB";$("#memFree").html(a),$("#now").html((new Date).toLocaleTimeString());for(var s=0;s<t.length;s++){var o=t[s],l=o.id,r=o.date,n=o.level,c=o.name+":"+o.lineNumber,i=o.message;let e='<tbody class="table-oddRow"><tr class="table-hasExpend">';r=r.substring(0,19);let a="";a="WARN"===n?'<td style="width: 30px"><span style="color: #f8ba0b; font-weight: bold">'+n+"</span></td>":"INFO"===n?'<td style="width: 30px"><span style="color: #00bbff; font-weight: bold">'+n+"</span></td>":'<td style="width: 30px"><span style="color: #1ea0c3" font-weight: bold">'+n+"</span></td>";var d=e+a+('<td><span style="word-wrap: break-word; white-space: normal; word-break: break-all; font-weight: bold"><span style="color: #4caf50">'+r+" "+c+"</span><br>"+i+"</span></td>")+"</tr></tbody>";if(void 0!==o.throwable){d+=o.throwable.class+": "+o.throwable.message+"<br>";for(var h=0;h<o.throwable.stackTrace.length;h++)d+=o.throwable.stackTrace[h]+"<br>"}$("#tabOthersPanel_log #logList").prepend(d),last=l}}}):$.ajax({url:Label.servePath+"/admin/logs",cache:!1,timeout:3e3,success:function(e){var t=e.result,a=t[t.length-1],s=a.id;let o=(e.freeMemNow/1048576).toFixed(2)+" MB";if($("#memFree").html(o),$("#now").html((new Date).toLocaleTimeString()),s!==last){var l=a.date,r=a.level,n=a.name+":"+a.lineNumber,c=a.message;let e='<tbody class="table-oddRow"><tr class="table-hasExpend">';l=l.substring(0,19);let t="";t="WARN"===r?'<td style="width: 30px"><span style="color: #f8ba0b; font-weight: bold">'+r+"</span></td>":"INFO"===r?'<td style="width: 30px"><span style="color: #00bbff; font-weight: bold">'+r+"</span></td>":'<td style="width: 30px"><span style="color: #1ea0c3" font-weight: bold">'+r+"</span></td>";var i=e+t+('<td><span style="word-wrap: break-word; white-space: normal; word-break: break-all; font-weight: bold"><span style="color: #4caf50">'+l+" "+n+"</span><br>"+c+"</span></td>")+"</tr></tbody>";if(void 0!==a.throwable){i+=a.throwable.class+": "+a.throwable.message+"<br>";for(var d=0;d<a.throwable.stackTrace.length;d++)i+=a.throwable.stackTrace[d]+"<br>"}$("#tabOthersPanel_log #logList").prepend(i)}last=s}})},removeUnusedArchives:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/archive/unused",type:"DELETE",cache:!1,success:function(e,t){$("#tipMsg").text(e.msg)}})},removeUnusedTags:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/tag/unused",type:"DELETE",cache:!1,success:function(e,t){$("#tipMsg").text(e.msg)}})},exportSQL:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/sql",type:"GET",cache:!1,success:function(e,t){e.sc?$("#tipMsg").text(e.msg):window.location=Label.servePath+"/console/export/sql"}})},exportJSON:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/json",type:"GET",cache:!1,success:function(e,t){e.sc?$("#tipMsg").text(e.msg):window.location=Label.servePath+"/console/export/json"}})},exportHexo:function(){$("#tipMsg").text(""),$.ajax({url:Label.servePath+"/console/export/hexo",type:"GET",cache:!1,success:function(e,t){e.sc?$("#tipMsg").text(e.msg):window.location=Label.servePath+"/console/export/hexo"}})},getUnusedTags:function(){$.ajax({url:Label.servePath+"/console/tag/unused",type:"GET",cache:!1,success:function(e,t){($("#tipMsg").text(e.msg),e.sc)?e.unusedTags.length:$("#loadMsg").text("")}})}},admin.register.others={obj:admin.others,init:admin.others.init,refresh:function(){admin.clearTip()}};
