...
admin.about={init:async function(){const t=version.split(" ")[0].substr(1),e=t.split(".").map(t=>parseInt(t,10));let n=[...e];const o=new Set;if("\u5185\u6d4b\u7248"===version.split(" ")[1])return void $("#updateCheck").html('\ud83c\udf4d <font style="color: #3caf36">\u60a8\u6b63\u5728\u4f7f\u7528\u83e0\u841d\u535a\u5ba2\u5185\u6d4b\u7248\u672c\uff0c\u611f\u8c22\u60a8\u5bf9\u5f00\u6e90\u7684\u8d21\u732e\uff01</font>');function i(t){return"v"+t.join(".")}function a(t){if(o.has(i(t)))return Promise.resolve(!1);o.add(i(t));const e="https://ftp.stackoverflow.wiki/bolo/releases/"+function(t){return"bolo_v"+t.join("_")+"_stable.zip"}(t);return new Promise(t=>{$.ajax({url:e,type:"HEAD",success:()=>t(!0),error:()=>t(!1)})})}function r(t,e){const n=Math.max(t.length,e.length);for(let o=0;o<n;o++){const n=t[o]||0,i=e[o]||0;if(n!==i)return n-i}return 0}function s(t){const e=[],n=t.length;for(let o=0;o<n;o++){let i=t.slice();i[o]++;for(let t=o+1;t<n;t++)i[t]=0;i.length<=3&&e.push(i)}if(n<3){let n=t.slice();n.push(0);for(let t=0;t<n.length;t++){let o=n.slice();o[t]++;for(let e=t+1;e<n.length;e++)o[e]=0;o.length<=3&&e.push(o)}}return e}await a(e)?(console.info("\u5f00\u59cb\u68c0\u6d4b\u65b0\u7248\u672c..."),await async function(){const t=[e];for(;t.length>0;){const e=s(t.shift());for(const o of e){await a(o)&&r(o,n)>0&&(n=o,t.push(o))}}}(),0===r(e,n)?$("#updateCheck").html('\ud83c\udf4d <font style="color: #3caf36">\u4f60\u6b63\u5728\u4f7f\u7528\u83e0\u841d\u535a\u5ba2\u6700\u65b0\u7248\uff01</font>'):$("#updateCheck").html(`<a href="https://github.com/adlered/bolo-solo/releases" target="_blank" style="color: #991a1a">\u83e0\u841d\u535a\u5ba2 ${i(n)} \u5df2\u63a8\u51fa\uff0c\u8d76\u5feb\u66f4\u65b0\u5427\uff01</a>`),$("#tipMsg").text(""),$("#loadMsg").text("")):$("#updateCheck").html('<font style="color: #e94c89">\u7248\u672c\u66f4\u65b0\u68c0\u67e5\u5931\u8d25\uff0c\u7f51\u7edc\u9519\u8bef\u6216\u8be5\u7248\u672c\u4e3a\u5185\u6d4b\u7248\u672c\u3002</font>')}},admin.register.about={obj:admin.about,init:admin.about.init,refresh:function(){admin.clearTip()}},admin.register.about={obj:admin.about,init:admin.about.init,refresh:function(){admin.clearTip()}},admin.register.about={obj:admin.about,init:admin.about.init,refresh:function(){admin.clearTip()}};
