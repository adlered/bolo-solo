...
admin.editors={},window.SoloEditor=function(e){this.conf=e,this.init()},$.extend(SoloEditor.prototype,{init:function(){$.ajax({url:"https://hacpai.com/apis/vcomment/users/emotions",type:"GET",cache:!0,async:!1,xhrFields:{withCredentials:!0},success:function(e){Label.emoji={},Array.isArray(e.data)&&e.data.forEach(e=>{const t=Object.keys(e)[0];Label.emoji[t]=e[t]})}});const e={mode:Label.editorMode,typewriterMode:this.conf.typewriterMode,cache:{enable:!0},tab:"\t",preview:{delay:500,mode:this.conf.previewMode,url:Label.servePath+"/console/markdown/2html",hljs:{enable:!Label.luteAvailable,style:Label.hljsStyle},parse:function(e){"none"!==e.style.display&&Util.parseMarkdown()}},upload:{max:10485760,url:Label.uploadURL,token:Label.uploadToken,filename:function(e){return e.replace(/[^(a-zA-Z0-9\u4e00-\u9fa5\.)]/g,"").replace(/[\?\\/:|<>\*\[\]\(\)\$%\{\}@~]/g,"").replace("/\\s/g","")}},height:this.conf.height,counter:{enable:!0,max:102400},resize:{enable:this.conf.resize},lang:Label.localeString,hint:{emojiTail:'<a href="https://hacpai.com/settings/function" target="_blank">\u8bbe\u7f6e\u5e38\u7528\u8868\u60c5</a>',emoji:Label.emoji},toolbarConfig:{pin:!0},after:()=>{"function"==typeof this.conf.fun&&this.conf.fun()}};$(window).width()<768&&(e.toolbar=["emoji","link","upload","insert-after","edit-mode","preview","fullscreen"],e.resize.enable=!1,e.toolbarConfig.pin=!0),"undefined"==typeof Vditor?Util.loadVditor(()=>{this.editor=new Vditor(this.conf.id,e)}):this.editor=new Vditor(this.conf.id,e)},getContent:function(){return this.editor.getValue()},setContent:function(e){this.editor.setValue(e)},remove:function(){document.getElementById(this.editor.vditor.id).outerHTML=""}}),admin.editors.articleEditor={},admin.editors.abstractEditor={};
