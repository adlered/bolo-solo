...
var plugins={};admin.plugin={plugins:[],add:function(t){t.isInit=!1,t.hash=t.path.replace("/","#")+"/"+t.id,this.plugins.push(t);var a=this._analysePath(t.path);t.index&&a.length<2&&this._addNew(t,a)},setCurByHash:function(t){for(var a=this.plugins,e=0;e<a.length;e++){var n=a[e],i=this._analysePath(n.path),s=!1;n.index&&window.location.hash.indexOf(n.hash)>-1?s=!0:(n.path.replace("/","#")===window.location.hash||"#main"===window.location.hash&&n.path.indexOf("/main/panel")>-1)&&(s=!0),s&&(n.isInit?plugins[n.id].refresh&&plugins[n.id].refresh(t.page):(n.index?2===i.length&&this._addNew(n,i):this._addToExist(n,i),plugins[n.id].init(t.page),n.isInit=!0))}},_analysePath:function(t){var a=t.split("/");return a.splice(0,1),a},_addNew:function(t,a){if(2===a.length)return t.target=$("#tabPreference li").get(t.index-1),void $("#tabPreference").tabs("add",t);""===a[0]?t.target=$("#tabs>ul>li").get(t.index-1):"article"===a[0]?t.target=$("#tabArticleMgt>li").get(t.index-1):"tools"===a[0]&&(admin.tools.push("#"+t.id),t.target=$("#tabTools>li").get(t.index-1)),t.target||alert("data.index is error!"),$("#tabs").tabs("add",t)},_addToExist:function(t,a){switch(a[0]){case"main":$("#mainPanel"+a[1].charAt(5)).append(t.content);break;case"tools":case"article":2===a.length?$("#tabsPanel_"+a[1]).append(t.content):$("#tabPreferencePanel_"+a[2]).append(t.content);break;case"comment-list":$("#tabsPanel_comment-list").append(t.content)}}};
admin.main={},admin.register.main={obj:admin.main,init:function(){admin.clearTip()},refresh:function(){admin.clearTip()}};
admin.about={init:function(){$.ajax({url:"https://rhythm.b3log.org/version/solo/latest/"+Label.version,type:"GET",cache:!1,dataType:"jsonp",success:function(e,o){var a=e.soloVersion;a===Label.version?$("#aboutLatest").text(Label.upToDateLabel):$("#aboutLatest").html(Label.outOfDateLabel+"<a href='"+e.soloDownload+"'>"+a+"</a>")},complete:function(e,o){admin.clearTip()}}),$.ajax({url:"https://hacpai.com/apis/sponsors",type:"GET",dataType:"jsonp",jsonp:"callback",success:function(e,o){for(var a=e.data.payments,t="",n=0;n<a.length;n++){var s="<b>\u533f\u540d\u597d\u5fc3\u4eba</b>";a[n].paymentUserName&&(s='<a href="https://hacpai.com/member/'+a[n].paymentUserName+'"><b>'+a[n].paymentUserName+"</b></a>"),t+='<li><div class="fn__flex">'+s+' <span class="ft__green fn__flex-1">&nbsp;'+a[n].paymentAmount+'RMB</span><time class="ft__fade">&nbsp;&nbsp;'+a[n].paymentTimeStr+"</time></div><div>"+a[n].paymentMemo+"</div></li>"}$("#adminAboutSponsors").html(t)},complete:function(e,o){admin.clearTip()}}),version=version.split(" ")[0],version=version.substr(1),version=version.replace(".","_");var e="bolo_v"+version+"_stable.zip",o="https://ftp.stackoverflow.wiki/bolo/releases/"+e;console.info("\u5f53\u524d\u7248\u672c\u6821\u9a8c\u4e2d\uff1a"+o);var a=version;$.ajax({url:o,type:"head",error:function(){$("#updateCheck").html('<font style="color: #e94c89">\u7248\u672c\u66f4\u65b0\u68c0\u67e5\u5931\u8d25\uff0c\u7f51\u7edc\u9519\u8bef\u6216\u8be5\u7248\u672c\u4e3a\u5185\u6d4b\u7248\u672c\u3002</font>'),$("#loadMsg").text("")},success:function(){console.info("\u5f53\u524d\u7248\u672c\u5728\u6570\u636e\u5e93\u4e2d\u5b58\u5728\uff01\u67e5\u8be2\u65b0\u7248\u672c...");var t=version.indexOf("_"),n=String(version.replace("_",""));console.info("\u7248\u672c\u5206\u9694\u7b26\u4f4d\u7f6e\uff1a"+t+"; \u7248\u672c\u5e8f\u5217\u53f7\uff1a"+n);for(var s=n.length,i=!0;i;){var r=(n=String(Number(n)+1)).length;s!==r&&t++,s=r,console.info("\u88f8\u7248\u672c\u53f7\uff1a"+n);var l=n.substr(0,t)+"_"+n.substr(t);console.info("\u67e5\u8be2\u53f7\uff1a"+l),o="https://ftp.stackoverflow.wiki/bolo/releases/"+(e="bolo_v"+l+"_stable.zip"),console.info("\u67e5\u8be2\u7248\u672c\u4ed3\u5e93\uff1a"+o),$.ajax({url:o,type:"head",async:!1,error:function(){console.info("\u7248\u672c v"+l.replace("_",".")+" \u4e0d\u5b58\u5728\uff0c\u505c\u6b62\u904d\u5386"),i=!1},success:function(){a=l,console.info("\u7248\u672c v"+l.replace("_",".")+" \u5b58\u5728\uff0c\u7ee7\u7eed\u67e5\u8be2\u4e0b\u4e00\u4e2a...")}})}version===a?$("#updateCheck").html('<font style="color: #3caf36">\u4f60\u6b63\u5728\u4f7f\u7528\u83e0\u841d\u535a\u5ba2\u6700\u65b0\u7248 :)</font>'):$("#updateCheck").html('<font style="color: #991a1a">\u83e0\u841d\u535a\u5ba2 v'+a.replace("_",".")+" \u5df2\u63a8\u51fa\uff0c\u8d76\u5feb\u66f4\u65b0\u5427\uff01</font>"),$("#loadMsg").text("")}})}},admin.register.about={obj:admin.about,init:admin.about.init,refresh:function(){admin.clearTip()}};
