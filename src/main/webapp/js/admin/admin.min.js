...
admin.about={init:async function(){const t=version.split(" ")[0].substr(1),e=t.split(".").map(t=>parseInt(t,10));let o=[...e];const n=new Set;if("\u5185\u6d4b\u7248"===version.split(" ")[1])return void $("#updateCheck").html('\ud83c\udf4d <font style="color: #3caf36">\u60a8\u6b63\u5728\u4f7f\u7528\u83e0\u841d\u535a\u5ba2\u5185\u6d4b\u7248\u672c\uff0c\u611f\u8c22\u60a8\u5bf9\u5f00\u6e90\u7684\u8d21\u732e\uff01</font>');function s(t){return"v"+t.join(".")}function l(t){if(n.has(s(t)))return Promise.resolve(!1);n.add(s(t));const e="https://ftp.stackoverflow.wiki/bolo/releases/"+function(t){return"bolo_v"+t.join("_")+"_stable.zip"}(t);return new Promise(t=>{$.ajax({url:e,type:"HEAD",success:()=>t(!0),error:()=>t(!1)})})}function r(t,e){const o=Math.max(t.length,e.length);for(let n=0;n<o;n++){const o=t[n]||0,s=e[n]||0;if(o!==s)return o-s}return 0}function i(t){const e=[],o=t.length;for(let n=0;n<o;n++){let s=t.slice();s[n]++;for(let t=n+1;t<o;t++)s[t]=0;s.length<=3&&e.push(s)}if(o<3){let o=t.slice();o.push(0);for(let t=0;t<o.length;t++){let n=o.slice();n[t]++;for(let e=t+1;e<o.length;e++)n[e]=0;n.length<=3&&e.push(n)}}return e}await l(e)?(console.info("\u5f00\u59cb\u68c0\u6d4b\u65b0\u7248\u672c..."),await async function(){const t=[e];for(;t.length>0;){const e=i(t.shift());for(const n of e){await l(n)&&r(n,o)>0&&(o=n,t.push(n))}}}(),0===r(e,o)?$("#updateCheck").html('\ud83c\udf4d <font style="color: #3caf36">\u4f60\u6b63\u5728\u4f7f\u7528\u83e0\u841d\u535a\u5ba2\u6700\u65b0\u7248\uff01</font>'):$("#updateCheck").html(`<a href="https://github.com/adlered/bolo-solo/releases" target="_blank" style="color: #991a1a">\u83e0\u841d\u535a\u5ba2 ${s(o)} \u5df2\u63a8\u51fa\uff0c\u8d76\u5feb\u66f4\u65b0\u5427\uff01</a>`),$("#tipMsg").text(""),$("#loadMsg").text("")):$("#updateCheck").html('<font style="color: #e94c89">\u7248\u672c\u66f4\u65b0\u68c0\u67e5\u5931\u8d25\uff0c\u7f51\u7edc\u9519\u8bef\u6216\u8be5\u7248\u672c\u4e3a\u5185\u6d4b\u7248\u672c\u3002</font>')}},admin.register.about={obj:admin.about,init:admin.about.init,refresh:function(){admin.clearTip()}};
