...
var usiteJSON={};admin.usite={locale:"",init:function(){$("#tabUsite").tabs(),$("#loadMsg").text(""),$.ajax({url:Label.servePath+"/admin/usite/get",type:"GET",async:!1,success:function(e){for(var t in usiteJSON=""===e.msg?$.parseJSON('\n{\n    "usiteUserId": "",\n    "usiteWeiBo": "",\n    "usiteQQMusic": "",\n    "usiteStackOverflow": "",\n    "usiteDribbble": "",\n    "usiteGitHub": "",\n    "usiteMedium": "",\n    "usiteTwitter": "",\n    "usiteQQ": "",\n    "usiteLinkedIn": "",\n    "usiteSteam": "",\n    "oId": "",\n    "usiteInstagram": "",\n    "usiteCodePen": "",\n    "usiteWYMusic": "",\n    "usiteWeChat": "",\n    "usiteZhiHu": "",\n    "usiteBehance": "",\n    "usiteTelegram": "",\n    "usiteFacebook": ""\n}\n\n'):$.parseJSON(e.msg))$("#"+t).val(usiteJSON[t])}})},validate:function(){return!0},update:function(){for(var e in usiteJSON){let t=$("#"+e).val();void 0===t&&(t=""),usiteJSON[e]=t}let t=JSON.stringify(usiteJSON);$.ajax({url:Label.servePath+"/admin/usite/set",type:"POST",async:!1,dataType:"json",data:t,success:function(e){200===e.code?($("#loadMsg").text("\u8054\u7cfb\u65b9\u5f0f\u5143\u6570\u636e\u66f4\u65b0\u6210\u529f\uff01"),setTimeout((function(){$("#loadMsg").text("")}),4e3)):($("#loadMsg").text("\u8054\u7cfb\u65b9\u5f0f\u5143\u6570\u636e\u66f4\u65b0\u5931\u8d25\uff01\u8bf7\u68c0\u67e5\u5143\u6570\u636e\u5185\u5bb9\u540e\u91cd\u8bd5\u3002"),setTimeout((function(){$("#loadMsg").text("")}),4e3))}})}},admin.register.usite={obj:admin.usite,init:admin.usite.init,refresh:function(){admin.clearTip()}};