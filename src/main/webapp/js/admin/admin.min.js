...
admin.articleList={tablePagination:new TablePaginate("article"),init:function(e){this.tablePagination.buildTable([{text:Label.titleLabel,index:"title",minWidth:110,style:"padding-left: 12px;font-size:14px;"},{text:Label.categoryLabel,index:"category",width:150,style:"padding-left: 12px;"},{text:Label.authorLabel,index:"author",width:150,style:"padding-left: 12px;"},{text:Label.commentLabel,index:"comments",width:80,style:"padding-left: 12px;"},{text:Label.viewLabel,width:60,index:"articleViewCount",style:"padding-left: 12px;"},{text:Label.dateLabel,index:"date",width:90,style:"padding-left: 12px;"}]),this.tablePagination.initPagination(),this.tablePagination.initCommentsDialog(),this.getList(e);var t=this;$("#articleListBtn").click((function(){t.getList(e)})),$("#articleListInput").keypress((function(a){13===a.keyCode&&t.getList(e)}))},syncToHacpai:function(e){$.ajax({url:Label.servePath+"/console/article/push2rhy?id="+e,type:"GET",cache:!1,success:function(e,t){$("#tipMsg").text(Label.pushSuccLabel)}})},getList:function(e){var t=this;$("#loadMsg").text(Label.loadingLabel),$.ajax({url:Label.servePath+"/console/articles/status/published/"+e+"/"+Label.PAGE_SIZE+"/"+Label.WINDOW_SIZE+"?k="+$("#articleListInput").val(),type:"GET",cache:!1,success:function(a,i){if($("#tipMsg").text(a.msg),a.sc){for(var l=a.articles,n=[],c=0;c<l.length;c++){n[c]={},n[c].title='<a href="'+Label.servePath+l[c].articlePermalink+"\" target='_blank' title='"+l[c].articleTitle+"' class='no-underline'>"+l[c].articleTitle+"</a><span class='table-tag'>"+l[c].articleTags+"</span>",n[c].date=$.bowknot.getDate(l[c].articleCreateTime),n[c].comments=l[c].articleCommentCount,n[c].articleViewCount=l[c].articleViewCount,n[c].author=l[c].authorName,n[c].category=l[c].articleCategory;var o=l[c].articlePutTop?Label.cancelPutTopLabel:Label.putTopLabel;"true"===Label.b3logEnabled?n[c].expendRow="<a href='javascript:void(0)' onclick=\"admin.article.get('"+l[c].oId+"', true)\">"+Label.updateLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.article.del('"+l[c].oId+"', 'article', '"+encodeURIComponent(l[c].articleTitle)+"')\">"+Label.removeLabel+"</a>                                <a href='javascript:void(0)' onclick=\"admin.articleList.syncToHacpai('"+l[c].oId+"')\">"+Label.pushToHacpaiLabel+"</a>                                <a href='javascript:void(0)' onclick=\"admin.articleList.popTop(this, '"+l[c].oId+"')\">"+o+"</a>                                <a href='javascript:void(0)' onclick=\"admin.comment.open('"+l[c].oId+"', 'article')\">"+Label.commentLabel+"</a>":n[c].expendRow="<a href='javascript:void(0)' onclick=\"admin.article.get('"+l[c].oId+"', true)\">"+Label.updateLabel+"</a>                                  <a href='javascript:void(0)' onclick=\"admin.article.del('"+l[c].oId+"', 'article', '"+encodeURIComponent(l[c].articleTitle)+"')\">"+Label.removeLabel+"</a>                                <a href='javascript:void(0)' onclick=\"admin.articleList.popTop(this, '"+l[c].oId+"')\">"+o+"</a>                                <a href='javascript:void(0)' onclick=\"admin.comment.open('"+l[c].oId+"', 'article')\">"+Label.commentLabel+"</a>"}t.tablePagination.updateTablePagination(n,e,a.pagination),$("#loadMsg").text("")}else $("#loadMsg").text("")}})},popTop:function(e,t){$("#loadMsg").text(Label.loadingLabel),$("#tipMsg").text("");var a=$(e),i="canceltop",l=Label.putTopLabel;a.html()===Label.putTopLabel&&(i="puttop",l=Label.cancelPutTopLabel),$.ajax({url:Label.servePath+"/console/article/"+i+"/"+t,type:"PUT",cache:!1,success:function(e,t){$("#tipMsg").text(e.msg),e.sc?(a.html(l),$("#loadMsg").text("")):$("#loadMsg").text("")}})}},admin.register["article-list"]={obj:admin.articleList,init:admin.articleList.init,refresh:admin.articleList.getList};
