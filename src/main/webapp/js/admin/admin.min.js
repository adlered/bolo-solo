...
admin.editors={};var SoloEditor=function(e){this.conf=e,this.init()};$.extend(SoloEditor.prototype,{init:function(){$.ajax({url:"https://"+Label.hacpaiDomain+"/apis/vcomment/users/emotions",type:"GET",cache:!0,async:!1,xhrFields:{withCredentials:!0},success:function(e){Label.emoji={},Array.isArray(e.data)&&e.data.forEach(e=>{const t=Object.keys(e)[0];Label.emoji[t]=e[t]})},error:function(e,t,o){$("#tipMsg").text("\u65e0\u6cd5\u4ece\u94fe\u6ef4\u793e\u533a\u83b7\u53d6\u5e38\u7528Emoji\uff0c\u81ea\u52a8\u751f\u6210\u4e2d..."),Label.emoji={};let i=JSON.parse('[{"+1":"\ud83d\udc4d"},{"-1":"\ud83d\udc4e"},{"confused":"\ud83d\ude15"},{"eyes":"\ud83d\udc40"},{"heart":"\u2764\ufe0f"},{"tada":"\ud83c\udf89"},{"smile":"\ud83d\ude04"},{"rocket":"\ud83d\ude80"}]');Array.isArray(i)&&i.forEach(e=>{const t=Object.keys(e)[0];Label.emoji[t]=e[t]})}});const e={outline:this.conf.outline||!1,mode:Label.editorMode,typewriterMode:this.conf.typewriterMode,cache:{enable:!0},tab:"\t",preview:{delay:500,mode:this.conf.previewMode,url:Label.servePath+"/console/markdown/2html",hljs:{enable:!Label.luteAvailable,style:Label.hljsStyle},parse:function(e){"none"!==e.style.display&&Util.parseMarkdown()}},upload:{max:107374182400,url:Label.uploadURL,linkToImgUrl:Label.servePath+"/upload/fetch",token:Label.uploadToken,filename:function(e){return e.replace(/[^(a-zA-Z0-9\u4e00-\u9fa5\.)]/g,"").replace(/[\?\\/:|<>\*\[\]\(\)\$%\{\}@~]/g,"").replace("/\\s/g","")}},height:this.conf.height,counter:{enable:!0,max:102400},resize:{enable:this.conf.resize},lang:Label.localeString,hint:{emojiTail:'<a href="https://'+Label.hacpaiDomain+'/settings/function" target="_blank">\u8bbe\u7f6e\u5e38\u7528\u8868\u60c5</a>',emoji:Label.emoji},toolbarConfig:{pin:!0},toolbar:["emoji","headings","bold","link","|","list","ordered-list","check","outdent","indent","|","quote","code","insert-before","insert-after","|","upload","record","table","|","undo","redo","|","fullscreen","edit-mode",{name:"more",toolbar:["italic","strike","line","inline-code","both","code-theme","content-theme","export","outline","preview","devtools","info","help"]}],after:()=>{"function"==typeof this.conf.fun&&this.conf.fun()}};$(window).width()<768&&(e.toolbar=["emoji","link","upload","edit-mode",{name:"more",toolbar:["insert-after","fullscreen","preview","info","help"]}],e.resize.enable=!1,e.toolbarConfig.pin=!0),"undefined"==typeof Vditor?Util.loadVditor(()=>{this.editor=new Vditor(this.conf.id,e)}):this.editor=new Vditor(this.conf.id,e)},getContent:function(){return this.editor.getValue()},setContent:function(e){this.editor.setValue(e)},remove:function(){document.getElementById(this.editor.vditor.id).outerHTML=""}}),admin.editors.articleEditor={},admin.editors.abstractEditor={};
