    ...
    <#if article.commentable>
        ...
        <div class="wrapper view-article">
            <div class="Valine v" data-class="v">
                <div class="vpanel">
                    <div class="vwrap">
                        <div class="vheader item3"><input name="nick" placeholder="昵称/QQ号(必填)" class="vnick vinput"
                                                          type="text"><input name="mail" placeholder="邮箱（接收提醒-必填）"
                                                                             class="vmail vinput" type="email"><input
                                    name="link" placeholder="个人站点(选填)" class="vlink vinput" type="text"></div>
                        <div class="vedit"><textarea id="veditor" class="veditor vinput"
                                                     placeholder="留下您的足迹吧 (●'◡'●)"></textarea>
                        </div>
                        <div class="vrow">
                ...
                <div class="vcount" style="display: block;"><span class="vnum">1</span> 评论</div>
                <div class="vload-top text-center" style="display:none;"><i class="vspinner"
                                                                            style="width:30px;height:30px;"></i></div>
                <div class="vcards">
                    <div class="vcard" id="603a003a600d62683e429b83"><img class="vimg"
                                                                          src="https://gravatar.loli.net/avatar/698d51a19d8a121ce581499d7b701668?d=wavatar&amp;v=1.4.14">
                        <div class="vh">
                            <div class="vhead"><a class="vnick" rel="nofollow" href="http://111"
                                                  target="_blank">1111</a><span class="vtag vvisitor">访客</span> <span
                                        class="vsys"><i class="fab fa-chrome"></i>Chrome 87.0.4280.88</span> <span
                                        class="vsys"><i class="fab fa-windows"></i>Windows 10.0</span></div>
                            <div class="vmeta"><span class="vtime">1 分钟前</span><span class="vat"
                                                                                     data-vm-id="603a003a600d62683e429b83"
                                                                                     data-self-id="603a003a600d62683e429b83">回复</span>
                            </div>
                            <div class="vcontent" data-expand="查看更多..."><p>hello</p>
                            </div>
                            <div class="vreply-wrapper" data-self-id="603a003a600d62683e429b83"></div>
                            <div class="vquote" data-self-id="603a003a600d62683e429b83"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="vpower txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v1.4.14
                </div>
            </div>
        </div>
        ...
        <div id="respond" class="comment-respond">
            ...
            <div class="comment-textarea">
                <textarea placeholder="${postCommentsLabel} ..." class="commentbody" id="comment" rows="5"
                          tabindex="4"></textarea><label class="input-label active">${postCommentsLabel} ...</label>
            </div>
        </div>
