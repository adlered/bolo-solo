                ...
                <div class="column is-12-tablet is-8-desktop is-8-widescreen is-8-fullhd has-order-2 column-main">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            count=article.articleCommentCount></@comments>
                        </div>
                    </div>
                </div>
                <div
...
<@comment_script oId=article.oId commentable=article.commentable>
    ...
    <#if 0 !=externalRelevantArticlesDisplayCount>
        page.loadExternalRelevantArticles("<#list article.articleTags?split(",") as
    articleTag>${articleTag}<#if articleTag_has_next>,</#if>
    </#list>",
